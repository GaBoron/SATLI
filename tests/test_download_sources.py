...
from satli.download_sources import DownloadSourceOrder
...
def test_defaults_prioritize_github_raw_for_index_only(
    ...
    monkeypatch.delenv("SATLI_INDEX_SOURCES", raising=False)
    monkeypatch.delenv("SATLI_FILE_SOURCES", raising=False)
...
def test_environment_configures_index_and_file_orders_independently(
    ...
    monkeypatch.setenv("SATLI_FILE_SOURCES", "github,jsdelivr-fastly,jsdelivr")
...
def test_environment_removes_duplicate_sources(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("SATLI_INDEX_SOURCES", "jsdelivr;jsdelivr;github")
...
def test_environment_rejects_unknown_source(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("SATLI_FILE_SOURCES", "jsdelivr;unknown")
...
def test_environment_rejects_index_only_source_for_files(
    ...
    monkeypatch.setenv("SATLI_FILE_SOURCES", "jsdelivr;staticdelivr")
