...
from satl.models import DiscoveryRecord, OwnedGame
from satl.network import NetworkTransport, describe_network_error
...
class SteamWebApiClient:
    ...
    def get_owned_games(self, api_key: str, steam_id: str) -> tuple[OwnedGame, ...]:
        ...
        request = urllib.request.Request(
            ...
            headers={"User-Agent": "satl/steam-library"},
        )
        try:
