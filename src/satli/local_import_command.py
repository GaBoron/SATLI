...
from satli.errors import IntegrityError, PreflightError, UsageError
from satli.local_import import LocalImportArtifact, read_local_import
from satli.models import SchemaVariant
from satli.steam import discover_installed_games, find_steam_dir, is_steam_running, schema_target
...
def command_local_import(args: argparse.Namespace) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="satli-local-import-") as temporary:
