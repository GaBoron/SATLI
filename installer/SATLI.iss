...
OutputBaseFilename=SATLI-Setup-v{#MyAppVersion}
...
Type: files; Name: "{app}\SATLInstaller.exe"
Type: files; Name: "{app}\satl.exe"
Type: files; Name: "{app}\satli.exe"
...
Type: filesandordirs; Name: "{app}\_satli_runtime"
