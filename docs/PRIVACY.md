...
Steam 成就翻译管理器以本地处理为主。扫描、编辑、备份和恢复都在当前 Windows 用户的设备上完成。
...
本地编辑只修改选择的目标语言，不会自动把本机 schema 上传到网络。
...
- GitHub：独立安装版获取软件更新信息和发布包；即将推出的 Microsoft Store 版不使用 GitHub 安装程序更新
